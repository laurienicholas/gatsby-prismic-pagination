    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
                            ...
                            switch (_c.label) {
                                case 0:
                                    ...
                                    query = "\n      query {\n        prismic {\n          " + args.prismicConnectionName + "(first: " + args.postsPerPage + (after ? ', after: "' + after + '"' : '') + "\n      " + (args.prismicConnectionArgs ? ", " + connectionArgs : '') + ") {\n            edges {\n              node {\n                " + (args.nodeFields
                                        ...
                                        : '') + "\n                _meta {\n                  id\n                  " + (args.nodeMeta
                                        ? args.nodeMeta.map(function (x) { return x + "\n                  "; })
                                        : '') + "\n                }\n              }\n            }\n            pageInfo {\n              hasNextPage\n              startCursor\n              endCursor\n              hasPreviousPage\n            }\n          }\n        }\n      }\n    ";
            ...
            case 2:
                ...
                allPosts.push.apply(allPosts, mostRecentResults.data.prismic[args.prismicConnectionName].edges);
            ...
            case 3:
                for (i = 0; i < allPages.length; i++) {
                    ...
                    args.createPage({
                        ...
                        context: __assign(__assign(__assign(__assign({ 
